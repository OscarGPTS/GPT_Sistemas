@props([
    'subject' => 'Notificación · GPT Services',
    'title' => 'Notificación',
    'greeting' => null,
    'intro' => null,
    'actionUrl' => null,
                    ...
                    <tr>
                        <td style="background:#f8fafc;padding:20px 32px;border-top:1px solid #e2e8f0;">
                            <p style="margin:0 0 6px;color:#64748b;font-size:12px;line-height:1.5;">
                                ...
                                Si tienes dudas contacta a <a href="mailto:{{ config('company.support_email') }}" style="color:#4f46e5;">{{ config('company.support_email') }}</a>.
                            </p>
